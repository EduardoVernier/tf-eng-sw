sap.ui.controller("com.sap.randon.view.customer.PendingTestsView", {
	...
	selectedPendingTestList : function(evt) {
		...
		if (!this.detailPage) {
			this.detailPage = sap.ui.xmlview("PendingTestsDetailView",
					"com.sap.randon.view.customer.PendingTestsDetailView");
	...
	onInit : function() {
		...
		this.emptyPage = new sap.ui.xmlview("Empty", "com.sap.randon.view.Empty");
		this.app.addPage(this.emptyPage, false);
		this.detailPage = new sap.ui.xmlview("PendingTestsDetailView", "com.sap.randon.view.customer.PendingTestsDetailView");
